...
servo4 = Servo(0, -90, 180, 500, 2500, 150, bias=0, direction=-1)
servo5 = Servo(1, -45, 225, 500, 2500, 150, bias=180, direction=1)
servo6 = Servo(3, -135, 135, 500, 2500, 150, bias=-2, direction=-1)
...
# Set position.
def moveToEuclidean(leg, position, a3=False):
    ...
    if angles is not None:
        ...
        maestro.end_together(servo1, servo2, servo3, update=True, time=100)
    else:
