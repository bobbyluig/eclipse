...
class Android:
    ...
    leg1 = Leg(servo1, servo2, servo3, (5.91, 7.13), 0, Finesse.inverse_pack, Finesse.forward_pack)
    ...
    leg2 = Leg(servo4, servo5, servo6, (5.91, 7.13), 1, Finesse.inverse_pack, Finesse.forward_pack)
    ...
    leg3 = Leg(servo7, servo8, servo9, (5.91, 7.13), 2, Finesse.inverse_pack, Finesse.forward_pack)
    ...
    leg4 = Leg(servo10, servo11, servo12, (5.91, 7.13), 3, Finesse.inverse_pack, Finesse.forward_pack)
    ...
    # Body
    body = Body(length=15.6, width=14.1, cx=0.4, cy=0, mb=20, ml=1)
