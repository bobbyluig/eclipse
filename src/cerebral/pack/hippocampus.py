...
class Android:
    ...
    servo2 = Servo(1, -45, 225, 500, 2500, 150, bias=3, direction=1)
    servo3 = Servo(2, -135, 135, 500, 2500, 150, bias=0, direction=-1)
    leg1 = Leg(servo1, servo2, servo3, (6.5, 7.25), 0, Finesse.inverse_pack, Finesse.forward_pack)

    # Leg 2.
    servo4 = Servo(3, -90, 180, 500, 2500, 150, bias=-7, direction=-1)
    servo5 = Servo(4, -225, 45, 500, 2500, 150, bias=-3, direction=1)
    servo6 = Servo(5, -135, 135, 500, 2500, 150, bias=4, direction=1)
    leg2 = Leg(servo4, servo5, servo6, (6.5, 7.25), 1, Finesse.inverse_pack, Finesse.forward_pack)

    # Leg 3.
    servo7 = Servo(6, -90, 180, 500, 2500, 150, bias=4, direction=1)
    ...
    # Head
    servo16 = Servo(16, -90, 90, 1000, 2000, 150, bias=0, direction=1)
    servo17 = Servo(17, -90, 90, 1000, 2000, 150, bias=0, direction=1)
    head = Head(servo16, servo17, camera)

    # Body
    body = Body(16.5, 15.5, 0.5, 0, 0, 20, 1)
