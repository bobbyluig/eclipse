...
If installing manually, you will need to compile `oculous`, which implements DSST and KCF corelation-based trackers and exposes them to Python3. Check the README in `theia/oculous` for more information.
